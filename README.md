## NumPy only neural networks library
...
A pure Python / NumPy implementation of neural networks library developed for educational purposes. Currently work in progress.
